...
Free Figma templates offer cost-effective solutions for designers, but quality and licensing may vary. Paid templates, while requiring an investment, generally provide higher quality, extensive features, and reliable support. 
...
<b>Cons:</b>> seems Figma is highlighting its plugins and team diagramming tools so can be harder to find more traditional templates that can help you with your aesthetics.
